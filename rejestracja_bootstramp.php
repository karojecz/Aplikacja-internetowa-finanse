					...
					$_SESSION['e_nick']="istnieje juz konto z takim loginem";
							...
							if($wszystko_OK==true)
							{
								if ($polaczenie->query("INSERT INTO users VALUES (NULL, '$login', '$haslo_hash', '$email')"))
								{
									...
									$q2=$polaczenie->query("INSERT INTO expenses_category_assigned_to_users(name) SELECT name FROM expenses_category_default");
										
									$q1=$polaczenie->query("UPDATE expenses_category_assigned_to_users SET user_id='$new_user_id' WHERE user_id=0");
