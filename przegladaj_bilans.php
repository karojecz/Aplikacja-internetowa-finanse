<?php
	...
	if ($polaczenie->connect_errno!=0)
	{
		...
		$_SESSION['income_sum'][$i]=$wiersz1['sum'];
...
var dataArray = [['Year','Total Average']];
				...
				var expense_names =<?php echo json_encode($_SESSION['expense_name']); ?>;
				var expense_sums =<?php echo json_encode($_SESSION['expense_sum']); ?>;
			...
			<div class="row">
					<div class="col-md-4 p-2">
						<table class="table table-bordered  ">
						   ...
						   echo
							  '<tr>
								 <th>'.$_SESSION['expense_sum'][$i].'</th><td>'.$_SESSION['expense_name'][$i].'</td> 
							  </tr>';
						   }
					...
					<div class="col-md-4 p-2">
						...
						<?php
						   ...
						   echo
							  '<tr>
								 <th>'.$_SESSION['income_sum'][$i].'</th><td>'.$_SESSION['income_name'][$i].'</td> 
							  </tr>';
						   }
